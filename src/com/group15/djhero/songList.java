...
public class songList{
	...
	public static String TERMINATING_STRING = "end";
	...
	public boolean addSongs(String songliststring) {
		...
		for (int i=0; i<parsed.length; i++){
			...
			if (temp.equals(TERMINATING_STRING)){
				Log.i("SongList","Finished adding songs - " + Songs.size() + " songs in songlist");
				return true;
			}
			else{
				try {
					...
					Log.i("SongList","Could not add song - Missing information");
