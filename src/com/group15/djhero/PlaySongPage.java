...
public class PlaySongPage extends Activity implements OnSeekBarChangeListener {
	...
	public void PausePlay (View view){
		...
		if(state == 0){
			SendMessage.sendMessage("pause ", myApp.sock);
			state++;
		}
		else{
			SendMessage.sendMessage("resume ", myApp.sock);
			state = 0;
		}
	}
	...
	public void songNext (View view){
		...
		SendMessage.sendMessage("next ", myApp.sock);
	...
	public void songPrevious (View view){
		...
		SendMessage.sendMessage("previous ", myApp.sock);
	}
	...
	public void onStopTrackingTouch(SeekBar arg0) 
	{
		...
		SendMessage.sendMessage("volume "+Integer.toString(volume), myApp.sock);
